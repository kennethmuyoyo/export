  ...
  return (
    <div className='relative min-h-full sm:mt-2 mt-5 sm:mx-16 px-9 mx-8 flex flex-col justify-center items-center text-center'>
      <div className="flex flex-col items-center text-center">
        <h2 className='mt-20 font-montserrat font-semibold sm:text-2xl text-xl'>WELCOME TO EXPORTIVA</h2>
        <div className='mb-8'>
      ...
      <div className="sm:grid sm:grid-cols-1 md:grid-cols-3 gap-4 items-center justify-center text-center sm:items-start sm:justify-start sm:text-start">
        <div className="md:col-span-2">
            <h2 className='sm:mt-12 mt-4 font-montserrat sm:text-2xl text-xl font-semibold'>ABOUT US</h2>
        ...
        <div className="md:col-span-1 flex items-center justify-center md:justify-end md:mr-10">
